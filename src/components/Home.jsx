...
export default function Home() {
  return (
    <section id="home" className="pt-32 pb-32 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-900 text-white relative overflow-hidden">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-lg md:text-xl text-blue-100">
                  Build, manage, and scale your online business with our powerful ecommerce platform. Everything you need in one place.
                </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <button className="bg-white text-blue-600 px-8 py-4 rounded-lg font-bold hover:bg-blue-50 transition shadow-lg hover:shadow-xl">
                  Get Started Free
                </button>
                <button className="bg-blue-500 text-white px-8 py-4 rounded-lg font-bold hover:bg-blue-400 transition border-2 border-white">
                  Watch Demo
                </button>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 pt-8">
                <div className="space-y-2">
                  ...
                  <p className="text-blue-100 text-sm md:text-base">Active Merchants</p>
                </div>
                <div className="space-y-2">
                  <p className="text-3xl md:text-4xl font-bold">10M+</p>
                  <p className="text-blue-100 text-sm md:text-base">Orders Processed</p>
                </div>
                <div className="space-y-2">
